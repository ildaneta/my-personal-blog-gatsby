...
var _ensureWindowsDriveLetterIsUppercase = _interopRequireDefault(require("./util/ensure-windows-drive-letter-is-uppercase"));
...
if (_os.default.platform() === `win32`) {
  (0, _ensureWindowsDriveLetterIsUppercase.default)();
...
if (!_semver.default.satisfies(process.version, `>=${NEXT_MIN_NODE_VERSION}`)) {
