...
// TODO: Replace this with proper type once reporter is typed
async function startServer(program) {
  ...
  let server = program.ssl ? _https.default.createServer(program.ssl, app) : new _http.default.Server(app);
