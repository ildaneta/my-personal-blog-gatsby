  ...
  const transformer = visitWithTypeInfo(typeInfo, {
    enter: {
      ...
      [Kind.FIELD]: node => {
        ...
        if (node.name.value === `id` || (node === null || node === void 0 ? void 0 : (_node$alias2 = node.alias) === null || _node$alias2 === void 0 ? void 0 : _node$alias2.value) === `id`) {
          context.hasId = true;
        }
      }
    },
    leave: {
      [Kind.SELECTION_SET]: node => {
        ...
        if (!context.hasId && (isObjectType(parentType) || isInterfaceType(parentType)) && hasIdField(parentType)) {
          extraFields.push({
            kind: Kind.FIELD,
            name: {
              kind: Kind.NAME,
