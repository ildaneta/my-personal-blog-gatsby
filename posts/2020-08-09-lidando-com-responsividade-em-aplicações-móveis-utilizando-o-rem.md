...
\
Como explicado acima, os dispositivos mobiles hoje possuem muitos formatos, que incluem o tamanho de altura e largura, mas também atrelado a quantidade de pixels que suporta as resoluções dos dispositivo, o que acaba impactando diretamente em seu layout pois quanto maior a densidade de pixels um dispositivo possui, mais pixels por polegada cabem em sua tela.
